  ...
  crm: {
    ...
    messages: {
      ...
      form: {
        ...
        relatedEntityIdLabel: 'Kayıt Kimliği (UUID)',
        relatedEntityIdHint: 'İlgili proje/teklif/görüşmenin kimliğini (ID) yapıştırın.',
        submit: 'Gönder',
      ...
      widget: {
        ...
        collapseAria: 'Daralt',
        closeAria: 'Kapat',
        unreadIndicatorAria: 'Okunmamış mesaj var',
