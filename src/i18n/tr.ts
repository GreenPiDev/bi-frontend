export const tr = {
  ...
  auth: {
    ...
    loginErrorToast: 'Giriş yapılamadı. Lütfen daha sonra tekrar deneyin.',
    fields: {
  ...
  datasets: {
    ...
    deleteTooltip: 'Sil',
    deleteConfirmTitle: 'Veri kümesini sil',
    deleteConfirm: 'Bu veri kümesini silmek istediğinize emin misiniz? Bu işlem geri alınamaz.',
    deleteSuccess: 'Veri kümesi silindi.',
    deleteError: 'Veri kümesi silinemedi.',
    deleteReadonlyTooltip: 'Bu veri kümesi sistem tarafından yönetilir, silinemez.',
    upload: {
      title: 'Dosya Yükle',
      ...
      stepPickHeaderTitle: 'Başlık Satırını Seç',
      rawPreviewInstructions:
        'Aşağıda dosyanın ilk satırları gösteriliyor. Hangi satırın sütun başlıkları olduğunu seçin (bazı dosyalarda başlıktan önce boş satır veya açıklama olabilir).',
      pickHeaderRowButton: 'Bu satır başlık',
      changeFileButton: 'Farklı dosya seç',
      creatingDataset: 'Veri kümesi oluşturuluyor...',
    },
    processing: {
  ...
  settings: {
    ...
    crm: {
      ...
      paymentMethodOptions: {
        ...
        subtitle:
          'Teklif formunda seçilebilecek ödeme yöntemi listesi. Bu listeden seçim yapılır, serbest metin girilemez.',
        addPlaceholder: 'Yeni ödeme yöntemi adı',
        addButton: 'Ekle',
        empty: 'Henüz ödeme yöntemi tanımlanmadı. Teklif formunda bu alan boş görünür.',
        editButton: 'Düzenle',
        saveButton: 'Kaydet',
        cancelButton: 'Vazgeç',
        deleteButton: 'Sil',
        addSuccess: 'Ödeme yöntemi eklendi.',
        editSuccess: 'Ödeme yöntemi güncellendi.',
        deleteSuccess: 'Ödeme yöntemi silindi.',
      },
      companyLogo: {
        title: 'Şirket Logosu',
        subtitle: 'Teklif gibi belgelerde kullanılacak şirket logosu.',
        alt: 'Şirket logosu',
        noLogo: 'Henüz logo eklenmemiş',
        uploadButton: 'Logo Yükle',
        replaceButton: 'Logoyu Değiştir',
        removeButton: 'Logoyu Kaldır',
        removeConfirmTitle: 'Logoyu kaldır',
        removeConfirmMessage: 'Şirket logosunu kaldırmak istediğinize emin misiniz?',
        unsupportedType: 'Sadece JPEG, PNG veya WEBP formatında görsel yüklenebilir.',
        tooLarge: 'Görsel 1,5 MB’dan büyük olamaz.',
        uploadSuccess: 'Şirket logosu güncellendi.',
        removeSuccess: 'Şirket logosu kaldırıldı.',
        uploading: 'Yükleniyor...',
      },
      ibanOptions: {
        title: 'IBAN / Banka Hesapları',
        subtitle:
          'Teklif formunda seçilebilecek banka hesabı listesi. Bu listeden seçim yapılır, serbest metin girilemez.',
        bankNameLabel: 'Banka',
        bankNamePlaceholder: 'Banka adı',
        accountHolderNameLabel: 'Alıcı Adı',
        accountHolderNamePlaceholder: 'Hesap sahibinin adı',
        accountNumberLabel: 'Hesap Numarası',
        accountNumberPlaceholder: 'Opsiyonel',
        ibanLabel: 'IBAN Numarası',
        ibanPlaceholder: 'TR__ ____ ____ ____ ____ ____ __',
        addButton: 'Ekle',
        empty: 'Henüz banka hesabı tanımlanmadı. Teklif formunda bu alan boş görünür.',
        editButton: 'Düzenle',
        saveButton: 'Kaydet',
        cancelButton: 'Vazgeç',
        deleteButton: 'Sil',
        addSuccess: 'Banka hesabı eklendi.',
        editSuccess: 'Banka hesabı güncellendi.',
        deleteSuccess: 'Banka hesabı silindi.',
        bankColumn: 'Banka',
        accountHolderColumn: 'Alıcı Adı',
        accountNumberColumn: 'Hesap No',
        ibanColumn: 'IBAN',
      },
      inactivityThreshold: {
  ...
  crm: {
    ...
    accounts: {
      ...
      form: {
        ...
        sectorHintRestricted:
          'Opsiyonel. Ayarlar → Tanımlamalar sayfasında tanımlanan sektörlerden birden fazlası seçilebilir.',
        sectorEmptyMessage: 'Henüz tanımlanmış bir sektör yok.',
        sectorEmptyLink: 'Tanımlamak için ayarlara git',
    ...
    contacts: {
      ...
      deleteButton: 'Sil',
      never: 'Hiç',
      interactionsTitle: 'Görüşmeler',
      noInteractions: 'Bu kişiyle ilgili görüşme kaydı yok.',
      newButton: 'Yeni Kişi',
      importButton: 'İçe Aktar',
      exportButton: 'Dışa Aktar',
    ...
    interactions: {
      ...
      form: {
        ...
        reminderTitleLabel: 'Başlık',
        reminderTitleHint: 'Zorunlu. Ajanda ekranında takvimde görünecek başlık.',
        reminderDescriptionLabel: 'Açıklama',
        reminderDescriptionHint: 'Opsiyonel. Ajanda ekranında hatırlatmaya tıklanınca görünür.',
        submit: 'Kaydet',
        submitting: 'Kaydediliyor...',
        cancel: 'Vazgeç',
    ...
    productLists: {
      ...
      actionsColumn: 'Aksiyonlar',
      deleteTooltip: 'Sil',
      deleteConfirmTitle: 'Ürün listesini sil',
      deleteConfirm: 'Bu ürün listesini silmek istediğinize emin misiniz?',
      deleteSuccess: 'Ürün listesi silindi.',
      form: {
    ...
    products: {
      ...
      filterListLabel: 'Ürün Listesi',
      filterListPlaceholder: 'Tüm listeler',
      actionsColumn: 'Aksiyonlar',
      editTooltip: 'Düzenle',
      deleteTooltip: 'Sil',
      selectColumn: 'Seç',
      selectedCount: (n: number) => `${n} ürün seçildi`,
      moveToListLabel: 'Hedef ürün listesi',
      movePlaceholder: 'Ürün listesi seçin',
      moveButton: 'Taşı',
      moving: 'Taşınıyor...',
      moveSuccess: 'Seçilen ürünler taşındı.',
    ...
    quotes: {
      ...
      detail: {
        ...
        quoteDateLabel: 'Teklif Tarihi',
        titleLabel: 'Başlık',
        leadTimeLabel: 'Termin Süresi',
        leadTimeEmpty: '—',
      ...
      form: {
        ...
        quoteDateLabel: 'Teklif Tarihi',
        quoteDateHint: 'Zorunlu. Teklif belgesinde görünecek tarih.',
        titleLabel: 'Başlık',
        titlePlaceholder: 'Örn. Ofis Mobilyaları Teklifi',
        titleHint: 'Opsiyonel.',
        leadTimeLabel: 'Termin Süresi',
        leadTimePlaceholder: 'Örn. 3 iş günü, 2 hafta, 2-3 hafta',
        leadTimeHint: 'Opsiyonel. Serbest metin olarak girilir.',
        paymentMethodLabel: 'Ödeme Yöntemi',
        paymentMethodPlaceholder: 'Ödeme yöntemi seçin',
        paymentMethodHint: 'Opsiyonel.',
        paymentMethodEmptyMessage: 'Henüz tanımlanmış bir ödeme yöntemi yok.',
        paymentMethodEmptyLink: 'Tanımlamak için ayarlara git',
        ibanLabel: 'IBAN / Banka Hesabı',
        ibanPlaceholder: 'Banka hesabı seçin',
        ibanHint: 'Opsiyonel.',
        ibanEmptyMessage: 'Henüz tanımlanmış bir banka hesabı yok.',
        ibanEmptyLink: 'Tanımlamak için ayarlara git',
        salesTermsLabel: 'Satış Koşulları',
        salesTermsPlaceholder: 'Satışa ilişkin koşulları yazın',
        salesTermsHint: 'Opsiyonel.',
        deliveryTermsLabel: 'Teslimat Koşulları',
        deliveryTermsPlaceholder: 'Teslimata ilişkin koşulları yazın',
        deliveryTermsHint: 'Opsiyonel.',
        productListLabel: 'Ürün Listesi',
